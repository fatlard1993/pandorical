...
/**
 * Clips its children to its bounds and scrolls them by whole items. The scroll is client-side
 * drawing only: children keep their built positions and ScreenHelper draws them shifted.
 */
public class ScrollPanelComponent extends AbstractComponent {
    ...
    /** Wheel travel not yet spent on a whole item: touchpads send runs of small fractions. */
